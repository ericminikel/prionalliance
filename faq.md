...
In the United States, predictive genetic testing for prion disease is performed by the [National Prion Disease Pathology Surveillance Center](https://case.edu/medicine/pathology/divisions/prion-center) in Cleveland (see above). Many people choose to discuss their interest in testing with a genetic counselor or medical geneticist before proceeding, but the genetic test can be ordered by any physician according to the instructions for physicians posted [here](https://case.edu/medicine/pathology/divisions/national-prion-disease-pathology-surveillance-center/clinical/blood-prnp-gene). It's free for people with a close relative confirmed to have a prion disease mutation. It costs $412 otherwise, which may or may not be covered by insurance depending on your plan. You may also incur health care costs associated with the doctor's visits to have blood drawn and receive counseling.
...
Two drug candidates designed to lower PrP, the protein that causes prion disease, are currently in clinical trials. The PrProfile trial ([NCT06153966](https://clinicaltrials.gov/study/NCT06153966)), run by Ionis Pharmaceuticals, is testing an antisense oligonucleotide called ION717. The PRiSM trial ([NCT07444580](https://clinicaltrials.gov/study/NCT07444580)), run by our team at the Broad Institute, is testing a divalent siRNA called PrP-siRNA. 

The advent of trials of PrP-lowering drugs, designed to target the root cause of prion disease, is a big step forward. Even still, a clinical trial is just an experiment: we do not know whether these drugs are safe or effective. Indeed, early trials are not even designed to determine whether a drug is effective, only to determine whether the drug is safe enough to proceed to larger trials, and to identify a dose level for further trials. Even if successful, reaching approval for a new drug takes years. We hope that other drugs will enter human trials in time, but no other candidates are ready for human testing at this time, and neither drug candidate is available on an Expanded Access or compassionate use basis at this time.
